...
global save_alphas_for_all_layers
global save_bns_for_bias
...
if __name__ == '__main__':
    ...
    training_args.add_argument('--model', type=str, default='vgg19-bn', choices=['fc','conv',
    ...
    training_args.add_argument('--model-bn', type=str, default='conv_netbn',
    ...
    training_args.add_argument('--dense-classifier', type=bool, default=True,
                        help='ensure last layer of model is dense (default: False)')
    ...
    training_args.add_argument('--pre-epochs', type=int, default=32,
                        help='number of epochs to train before pruning (default: 0)')
    training_args.add_argument('--full-epochs', type=int, default=160,
                        help='number of epochs to train before pruning (default: 0)')
    training_args.add_argument('--post-epochs', type=int, default=32,
                        help='number of epochs to train after pruning (default: 10)')
    training_args.add_argument('--lr', type=float, default=0.1,
                        help='learning rate (default: 0.001)')
    training_args.add_argument('--lr-drops', type=int, nargs='*', default=[12,24],
    ...
    training_args.add_argument('--weight-decay', type=float, default=0.0001,
    ...
    pruning_args.add_argument('--prune-bias', type=bool, default=True,
    ...
    pruning_args.add_argument('--compression-list', type=float, nargs='*', default=[1.22],
                        help='list of compression ratio exponents for singleshot/multishot (default: [])')
    pruning_args.add_argument('--level-list', type=int, nargs='*', default=[5],
    ...
    parser.add_argument('--result-dir', type=str, default='Results/data',
                        help='path to directory to save results (default: "/home/c01gokr/CISPA-home/results/data"')
